package io.diaryofrifat.code.basemvpkt.data

import android.content.Context
import io.diaryofrifat.code.basemvpkt.data.local.AppLocalDataSource
import io.diaryofrifat.code.basemvpkt.data.local.user.UserEntity
import io.diaryofrifat.code.basemvpkt.data.remote.AppRemoteDataSource
